...
public class OrderSystem implements AutoCloseable {
    ...
    private boolean breakFlag = false; // true : break
    ...
    public void showAllItems(List<Menu> menuList, int selectedMenuNumber) {
        ...
        else if(selectedMenuNumber == menuList.size() + 1)
        {
            ...
            System.out.println("1. 주문 \t 2.메뉴판 \t 3.품목 제거");
        ...
        try {
            ...
            if(!menuFlag) {
                ...
                if(selectedItemNumber == 1) {
                    ...
                    System.out.println("제거할 품목의 이름을 입력해주세요.");
                    String itemName = sc.nextLine();
                    if(shoppingCart.removeItem(itemName)) {
                        System.out.println("성공적으로 제거했습니다.");
                    } else
                    {
